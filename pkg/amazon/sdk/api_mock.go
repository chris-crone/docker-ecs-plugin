...
import (
	...
	types "github.com/docker/ecs-plugin/pkg/amazon/types"
...
func (m *MockAPI) CreateChangeSet(arg0 context.Context, arg1 string, arg2 *cloudformation0.Template, arg3 map[string]string) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) CreateSecret(arg0 context.Context, arg1 types.Secret) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) DescribeTasks(arg0 context.Context, arg1 string, arg2 ...string) ([]types.TaskStatus, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetLogs(arg0 context.Context, arg1 string, arg2 types.LogConsumer) error {
	m.ctrl.T.Helper()
...
func (m *MockAPI) InspectSecret(arg0 context.Context, arg1 string) (types.Secret, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) ListSecrets(arg0 context.Context) ([]types.Secret, error) {
	m.ctrl.T.Helper()
